...
workdirectory <- paste0("E:/_HONOURS_DATA/TESTS/TEST ANALYSIS ADD/pbs.", WD , ".tinmgr2")
setwd(workdirectory)
...
if (MODELTYPE == "ADD") {
  seeds <- read.csv("E:/_HONOURS_DATA/RESOURCES/ADD/miniseeds.csv")
  combos <-read.csv("E:/_HONOURS_DATA/RESOURCES/ADD/minicombo.csv")
} else if (MODELTYPE == "ODE") {
  seeds <- read.csv("E:/_HONOURS_DATA/RESOURCES/ODE/miniseeds.csv")
  combos <-read.csv("E:/_HONOURS_DATA/RESOURCES/ODE/minicombo.csv")
} else {
